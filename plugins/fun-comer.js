...
    // Mensaje indicando que la persona está comiendo
    let str = `${name2} Está comiendo una deliciosa baguette 🥖❤`.trim();    // Si es un grupo, seleccionamos un video aleatorio y lo enviamos
    if (m.isGroup){
...
handler.help = ['comer'];
handler.tags = ['game'];
handler.command = ['eat', 'comer','tragar', 'baguette'];
handler.group = true;

let handler = async (m, { conn }) => {
  ...
  conn.reply(m.chat, `
╭━━━━━━━━━━━━━━━━━━━━━━━╮
│ � *BAGUETTE DE LA FORTUNA* �
╰━━━━━━━━━━━━━━━━━━━━━━━╯

Hola ${username}! Teto ha preparado tu baguette de la fortuna...
...
❤ ¡Que tengas un lindo día! Teto siempre estará aquí para cantar para ti 🎤
  `, m);
...
handler.help = ['fortuna', 'baguette', 'suerte']
handler.tags = ['fun', 'entertainment']
handler.command = /^(fortuna|galleta|suerte|baguette)$/i

...
await conn.sendMessage(m.chat, { document: base64, mimetype: 'audio/mpeg', fileName: `${gi.data.title}.mp3` }, { quoted: m })
await m.react('✅')
} catch (error) {
try {
await m.react('🕓')
...
await conn.sendMessage(m.chat, { document: { url: dl_url }, fileName: `${title}.mp3`, mimetype: 'audio/mp4' }, { quoted: m })
await m.react('✅')
} catch (error) {
await m.react('✖️')
}}}
